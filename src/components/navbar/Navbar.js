...
import { navLinksdata } from '../../assets/constants';
...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-24 sticky top-0 z-50 bg-bodyColor mx-auto flex justify-between items-center
    ...
    <div>
      ...
      <ul className="hidden mdl:inline-flex items-center gap-6 lg:gap-10">
        ...
        <span
          ...
          className="text-xl mdl:hidden bg-black w-10 h-10 inline-flex items-center justify-center rounded-full
